...
==== 요청
operation::user-account-controller-test/show-major-careers-success-test[snippets="http-request,request-fields"]
==== 응답
...
==== 요청
operation::user-account-controller-test/show-middle-careers-success-test[snippets="http-request,request-fields"]
==== 응답
...
==== 요청
operation::user-account-controller-test/show-small-careers-success-test[snippets="http-request,request-fields"]
==== 응답
...
==== 요청
operation::user-account-controller-test/show-careers-fail-test[snippets="http-request,request-fields"]
==== 응답
