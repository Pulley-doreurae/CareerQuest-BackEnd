...
/**
 * 자격증에서 쟈주 사용되는 메서드 모음
 *
 * @author : parkjihyeok
 * @since : 2024/05/12
 */
@Service
public class CommonCertificationService extends CommonCommunityService {

	@Autowired
	public CommonCertificationService(PostRepository postRepository, UserAccountRepository userAccountRepository,
	...
	public Post postRequestToPost(PostRequest postRequest, UserAccount user) {
		return CertificationReview.builder()
				.userAccount(user)
