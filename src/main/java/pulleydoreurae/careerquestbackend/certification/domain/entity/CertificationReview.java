...
public class CertificationReview extends Post {
	...
	public CertificationReview(Long id, UserAccount userAccount,
			String title, String content, Long view, List<PostLike> postLikes, PostCategory postCategory,
			String certificationName) {

		super(id, userAccount, title, content, view, postLikes, postCategory, certificationName, null, null);
	}
}
