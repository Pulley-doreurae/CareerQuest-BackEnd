package pulleydoreurae.chwijunjindan.mail.service;
...
public class MailService {
     ...
     */
    public void sendMail(String userId, String userName, String phoneNum, String email, String password) throws NoSuchAlgorithmException {
